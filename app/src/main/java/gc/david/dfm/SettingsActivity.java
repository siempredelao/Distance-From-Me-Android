    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bbddPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				((DFMApplication) getApplicationContext()).getDaoSession().deleteAll(Distance.class);
				((DFMApplication) getApplicationContext()).getDaoSession().deleteAll(Position.class);
