 ...
 * MigrationV2ToV3 would be called by the [UpgradeHelper] it would defer
...
interface Migration {
     ...
     * version is too old for this migration. NB: This will only be null
     * if this is the tip of the chain and there are no other earlier
     * migrations.
     */
    fun getPreviousMigration(): Migration?

    /**
     * @return the target (old) version which will be migrated from.
     */
    fun getSourceVersion(): Int
