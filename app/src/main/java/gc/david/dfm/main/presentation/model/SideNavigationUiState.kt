 ...
 * @property showLoadMenuItem Whether to show the Load menu item
 * @property showDebugOptions Whether to show a set of menu items useful while developing the app
 */
